...
const FANTOM_LIST = 'https://raw.githubusercontent.com/fort1a/uniswap_v3_tokenlist/main/tokenlist/tokenlist.json'
...
export const DEFAULT_ACTIVE_LIST_URLS: string[] = [UNI_LIST, FANTOM_LIST]
